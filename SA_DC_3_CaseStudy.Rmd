...
#Analyzing the TV news dataset about weather condition over 7 Years
...
###Question :what words are most common when discussing climate change on TV news, as well as the total number of words from each station?
...
Comments: Common words include climate,change,warmig..
...
**Comments: MSNBC used a low proportion of negative words but a high proportion of positive words, the reverse is true of FOX News, and CNN is middle of the pack.**
...
**Comments : Some words, like “threat” are used by all three stations but some word choices are quite different. FOX News talks about terrorism and hurricanes, while CNN discusses hoaxes.**
...
**Comments : The proportion of positive words looks flat, and the proportion of negative words may be increasing.**
...
**Comments : We can see that words like “hoax” and “denier” have been used only recently, and “warming” is decreasing in monthly uses. We can see when a hurricane was being discussed as well.**